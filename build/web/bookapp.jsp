<%-- 
    ...
    Created on : 19-Dec-2022, 11:06:21 am
    Author     : Sowmi
--%>
...
//    String blood = request.getParameter("blood");
    ...
    ResultSet rs1 = stm.executeQuery("select state, district, city, bname, hname, category, contact, email, userid, time from bloodbank where state ='" + state + "' and district='" + district + "'");
        ...
        <main id="main">
            ...
            <TABLE id="customers">
                ...
                <tr style="margin-top: 5px;">
                    ...
                    <TD> <p id="val"><a href="#" onclick="alert('Registered successfully!');">Register now</a></p></TD>
