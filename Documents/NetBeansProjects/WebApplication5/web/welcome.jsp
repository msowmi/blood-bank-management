<%-- 
    Document   : welcome
    Created on : 08-Dec-2022, 3:01:39 pm
    Author     : Sowmi
--%>
...
<%
    ...
    ResultSet rs1 = st1.executeQuery("select * from search where status=false order by time desc");
%>
<!DOCTYPE html>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  * License: https://bootstrapmade.com/license/
  ======================================================== -->
        ...
        fetch('http://localhost:8080/bloodbank/ItemRecommender').then(response => {return response.json();})  

	.then(data => {console.log(data);

        var f = document.createElement("form");

        f.action = "ratingbb.jsp";
        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between ">
            ...
            <nav id="navbar " class="navbar ">
                <ul>
                    ...
                    <li>
                        <a><button onclick="myRecommend()" id="splbtn">Blood Banks</button></a>
                    </li>
            ...
            <div class="row gy-5 " data-aos="fade-in ">
                <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start ">
                    ...
                    <div class="d-flex justify-content-center justify-content-lg-start ">
                        <% if(n!=1){%>
                        <a href="profile.jsp " class="btn-get-started ">Get Started</a>
                        <%}else{%>
                        
                        <a href="viewprofile.jsp " class="btn-get-started ">View Profile</a>
                        <%}%>
...
<TABLE id="customers">
                ...
                <td><form method = "post" action = "donate.jsp"><input type="hidden" name="reqid" value="<%= rs1.getString(9)%>"><input type="hidden" name="blood" value="<%= rs1.getString(7)%>"><input type="hidden" name="hosp" value="<%= rs1.getString(10)%>"><input type="hidden" name="city" value="<%= rs1.getString(5)%>"><button><i class="fa-solid fa-droplet"></i>&nbsp;donate now</button></form></td>
                </tr>
                <%}%>
</table>
