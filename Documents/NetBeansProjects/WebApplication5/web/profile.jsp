<%-- 
    Document   : profile
    Created on : 09-Dec-2022, 2:05:25 pm
    Author     : Sowmi
--%>
...
<!--      <div class="page-header d-flex align-items-center" style="background-image: url('');">
     ...
     <!-- ======= profile section ======= -->
     <h1 id="title" style="margin-left: 60px">Donar Registration Form</h1>
    <div class="container">
  <form action="details.jsp">
    ...
    <div class="row">
      <div class="col-25">
        <label for="street" class="req">Have you ever donated blood? </label>
      </div>
      <div class="col-75">
       <input type="radio" name="donated" value="yes" /> Yes
       <input type="radio" name="donated" value="no" /> No
      </div>
    </div>
    <div class="row">
      <div class="col-25">
        <label for="dob">Latest Blood Donation date(if any)</label>
      </div>
      <div class="col-75">
       <input name="lastdonated" type="date" id="myDate" value="yyyy-mm-dd">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
