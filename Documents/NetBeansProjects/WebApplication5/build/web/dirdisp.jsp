<%-- 
    Document   : dirdisp
    Created on : 16-Dec-2022, 7:35:56 pm
    Author     : Sowmi
--%>

<%-- 
    Document   : availdisp
    Created on : 16-Dec-2022, 6:27:53 pm
    Author     : Sowmi
--%>
...
//    String blood = request.getParameter("blood");
    ...
    ResultSet rs1 = stm.executeQuery("select *from bloodbank where state ='" +state+"' and district='"+district+"'");
...
<TABLE id="customers">
                ...
                <TD> <p id="val"><%= rs1.getString(18)%></p></TD>
                <TD> <p id="val"><%= rs1.getString(10)%></p></TD>
                <TD> <p id="val"><%= rs1.getString(11)%></p></TD>
                <TD> <p id="val"><%= rs1.getString(12)%></p></TD>
                <TD> <p id="val"><%= rs1.getString(13)%></p></TD>
                <TD> <p id="val"><%= rs1.getString(14)%></p></TD>
                <TD> <p id="val"><%= rs1.getString(15)%></p></TD>
                <TD> <p id="val"><%= rs1.getString(16)%></p></TD>
                <TD> <p id="val"><%= rs1.getString(17)%></p></TD>
