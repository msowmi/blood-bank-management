<%-- 
    ...
    Created on : 09-Dec-2022, 4:34:25 pm
    Author     : Sowmi
--%>
...
<%
    ...
    ResultSet rs2 = stm.executeQuery("select * from details where userid = " + myid);
    rs2.next();
%>
<!DOCTYPE html>
<html lang="en">
...
<!--        <ul>
        ...
        <ul>
                    ...
                    <li><a href="#team ">Team</a></li>-->
                    <li>
                        <a href="blog.html "style="text-decoration: none">Notification</a>
                    </li>
                    <li class="dropdown "><a href="# "style="text-decoration: none"><span>Search for Blood</span> <i class="bi bi-chevron-down dropdown-indicator "></i></a>
                        <ul>
                            <li><a href="# " style="text-decoration: none">Search for Blood</a></li>
                            <!-- <li class="dropdown "><a href="# "><span>Deep Drop Down</span> <i class="bi bi-chevron-down dropdown-indicator "></i></a>
                                <ul>
                                    <li><a href="# ">Deep Drop Down 1</a></li>
                                    <li><a href="# ">Deep Drop Down 2</a></li>
                            ...
                            <li><a href="# " style="text-decoration: none">Blood Donation camps</a></li>
                            <li><a href="# " style="text-decoration: none">Voluntary Donar Group</a></li>
                            <li><a href="# " style="text-decoration: none">About Blood donation</a></li>
                        </ul>
                    </li>
                    <li class="dropdown "><a href="# " style="text-decoration: none"><span>Donate Blood</span> <i class="bi bi-chevron-down dropdown-indicator "></i></a>
                        <ul>
                            ...
                            <li><a href="# " style="text-decoration: none">Blood availability</a></li>
                            <li><a href="# " style="text-decoration: none">Blood bank directory</a></li>
                            <!-- <li><a href="# ">Drop Down 4</a></li> -->
                        </ul>
                    </li>
...
<!--      <div class="page-header d-flex align-items-center" style="background-image: url('');">
     ...
     <!-- ======= profile section ======= -->
     <h1 id="title" style="margin-left: 60px">Your Profile</h1>
    <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-75">
        ...
        <label><%= rs2.getString(8)%></label>
      </div>
    </div>
     <div class="row">
      <div class="col-25">
        <label for="dob" class="req">DOB </label>
      </div>
      <div class="col-75">
       <label><%= rs2.getString(9)%></label>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
