<%-- 
    Document   : addbb
    Created on : 16-Dec-2022, 3:53:14 pm
    Author     : Sowmi
--%>
...
<!--      <div class="page-header d-flex align-items-center" style="background-image: url('');">
     ...
     <!-- ======= profile section ======= -->
     <h1 id="title" style="margin-left: 60px">Blood Bank Details</h1>
    <div class="container">
  <form action="add.jsp">
      <h4 style="margin-left:180px;">Blood Bank Address</h4>
...
$("#inputState").change(function(){
 ...
 <div class="row">
      <div class="col-25">
    <label for="inputCity" class="req">City</label>
...
<div class="container">
     ...
     <h4 style="margin-left:180px;">Blood Bank Details</h4>
    <div class="row">
      <div class="col-25">
        <label for="fname" class="req">Blood Bank Name</label>
      </div>
      <div class="col-75">
    ...
    <div class="row">
      <div class="col-25">
        <label for="hname" class="req">Parent Hospital Name </label>
      </div>
      <div class="col-75">
      ...
      <div class="row">
      <div class="col-25">
        <label for="blood" class="req">Category </label>
      </div>
      <div class="col-75">
       <select id="dropdown" name="cat" class="m-t-xs">
    ...
    <div class="row">
      <div class="col-25">
        <label for="phone" class="req">Contact No. </label>
      </div>
      <div class="col-75">
    ...
    <div class="row">
     ...
     <div class="row">
      <div class="col-25">
        <label for="email" class="req">Donation Time </label>
      </div>
      <div class="col-75">
