...
<%
    ...
    ResultSet rs1 = stm.executeQuery("select state, district, city, \""+blood+"\" ,bname, hname, category, contact, email from bloodbank where state ='" + state+"' and district='"+district+"' and \""+blood+"\" ='Available'");
...
$("#inputState").change(function(){
  ...
  $("#inputDistrict").html(htmlString);
         ...
         <div class="row">
      <div class="col-25">
    <label class="req">Blood Group</label>
      </div>
    <div class="col-75">
